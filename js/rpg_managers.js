...
Object.defineProperties(TextManager, {
    ...
    toTitle         : TextManager.getter('command', 22),
    cancel          : TextManager.getter('command', 23),
    buy             : TextManager.getter('command', 25),
    sell            : TextManager.getter('command', 26),
    sensory         : TextManager.getter('command', 27),
    recollection    : TextManager.getter('command', 28),
    mind            : TextManager.getter('command', 29),
    nerve           : TextManager.getter('command', 30),
